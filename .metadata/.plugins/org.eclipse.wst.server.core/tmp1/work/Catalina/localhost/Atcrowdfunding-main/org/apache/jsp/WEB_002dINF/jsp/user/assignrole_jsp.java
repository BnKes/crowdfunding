 ...
 * Generated at: 2019-11-10 04:50:55 UTC
...
public final class assignrole_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<select id=\"leftRoleList\" class=\"form-control\" multiple size=\"10\" style=\"width:250px;overflow-y:auto;\">\r\n");
      out.write("                        ");
      ...
      out.write("\t\t\t\t  <div class=\"form-group\">\r\n");
      out.write("                        <ul>\r\n");
      out.write("                            <li id=\"leftToRightBtn\" class=\"btn btn-default glyphicon glyphicon-chevron-right\"></li>\r\n");
      out.write("                            <br/>\r\n");
      out.write("                            <li id=\"rightToLeftBtn\" class=\"btn btn-default glyphicon glyphicon-chevron-left\" style=\"margin-top:20px;\"></li>\r\n");
      out.write("                        </ul>\r\n");
      out.write("\t\t\t\t  </div>\r\n");
      out.write("\t\t\t\t  <div class=\"form-group\" style=\"margin-left:40px;\">\r\n");
      out.write("\t\t\t\t\t<label for=\"exampleInputPassword1\">已分配角色列表</label><br>\r\n");
      out.write("\t\t\t\t\t<select id=\"rightRoleList\" class=\"form-control\" multiple size=\"10\" style=\"width:250px;overflow-y:auto;\">\r\n");
      out.write("                        ");
      ...
      out.write("            });\r\n");
      out.write("            \r\n");
      out.write("            $(\"#leftToRightBtn\").click(function(){\r\n");
      out.write("               \tvar selectedOptions = $(\"#leftRoleList option:selected\");\r\n");
      out.write("\r\n");
      out.write("               \tvar num  = selectedOptions.size();\r\n");
      out.write("               \t\r\n");
      out.write("            \tif(num==0){\r\n");
      out.write("               \t\tlayer.msg(\"左侧请至少选择一个角色\", {time:1000, icon:5, shift:6});\r\n");
      ...
      out.write("               \t};\r\n");
      out.write("               \t\r\n");
      out.write("               \t$.each(selectedOptions,function(i,n){\r\n");
      out.write("               \t\tjsonObj[\"ids[\"+i+\"]\"] = this.value ;  \r\n");
      out.write("               \t});\r\n");
      out.write("               \t\r\n");
      ...
      out.write("                \t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${APP_PATH}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/user/doAssignRole.do\",\r\n");
      ...
      out.write("                \t\t\t\t$(\"#rightRoleList\").append(selectedOptions.clone());\r\n");
      out.write("                            \tselectedOptions.remove();\r\n");
      out.write("                \t\t\t}else{\r\n");
      ...
      out.write("            });\r\n");
      out.write("            \r\n");
      out.write("            $(\"#rightToLeftBtn\").click(function(){\r\n");
      out.write("               \tvar selectedOptions = $(\"#rightRoleList option:selected\");\r\n");
      out.write("               \t\r\n");
      out.write("               \tvar num  = selectedOptions.size();\r\n");
      out.write("            \tif(num==0){\r\n");
      out.write("               \t\tlayer.msg(\"右侧请至少选择一个角色\", {time:1000, icon:5, shift:6});\r\n");
      out.write("               \t\treturn false;\r\n");
      out.write("               \t}\r\n");
      out.write("            \t\r\n");
      out.write("               \tvar jsonObj = {\r\n");
      ...
      out.write("                   \t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${APP_PATH}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/user/doUnAssignRole.do\",\r\n");
      out.write("                   \t\tbeforeSend : function() { \r\n");
      out.write("                   \t\t\tloadingIndex = layer.load(2, {time: 10*1000});\r\n");
      out.write("                   \t\t\treturn true ;\r\n");
      out.write("                   \t\t},\r\n");
      ...
      out.write("                   \t\t\tlayer.close(loadingIndex);\r\n");
      out.write("                   \t\t\tif(result.success){\r\n");
      out.write("                   \t\t\t\t$(\"#leftRoleList\").append(selectedOptions.clone());\r\n");
      out.write("                               \tselectedOptions.remove();\r\n");
      out.write("                   \t\t\t}else{\r\n");
      out.write("                   \t\t\t\tlayer.msg(result.message, {time:1000, icon:5, shift:6});\r\n");
      out.write("                   \t\t\t}\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/user/assignrole.jsp(62,24) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/jsp/user/assignrole.jsp(62,24) '${leftRoleList }'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${leftRoleList }",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /WEB-INF/jsp/user/assignrole.jsp(62,24) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/user/assignrole.jsp(77,24) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/jsp/user/assignrole.jsp(77,24) '${rightRoleList }'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${rightRoleList }",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /WEB-INF/jsp/user/assignrole.jsp(77,24) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
