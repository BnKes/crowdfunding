 ...
 * Generated at: 2019-11-20 06:56:43 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsp.advert;
...
static {
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<form class=\"form-inline\" id=\"form\" style=\"float: left;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-warning\" onclick=\"queryAdvert()\">\r\n");
      ...
      out.write("/advert/index.htm?pageno=\"+pageno;\r\n");
      out.write("            \tqueryPage(pageno-1);\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            //使用Ajax异步查询数据\r\n");
      out.write("            function queryPage( pageIndex ){\r\n");
      out.write("            \tvar dataObj = {\r\n");
      out.write("        \t\t\t\"pageno\" : pageIndex+1 ,   //pageno 是属性名称,是否增加双引号无所谓\r\n");
      out.write("        \t\t\t\"pagesize\" : 2\r\n");
      out.write("        \t\t};\r\n");
      out.write("            \tif(condition){\r\n");
      out.write("            \t\tdataObj.pagetext = $(\"#queryText\").val(); //增加模糊查询条件\r\n");
      out.write("            \t}\r\n");
      out.write("            \t\r\n");
      ...
      out.write("            \t\t\t\tvar list = pageObj.data ;\r\n");
      out.write("            \t\t\t\tvar content = \"\";\r\n");
      out.write("            \t\t\t\t$(\"tbody\").html(content);\r\n");
      out.write("            \t\t\t\t$.each(list,function(i,n){\r\n");
      out.write("            \t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tcontent+=\"\t<td>\"+n.url+\"</td>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\tif(n.status=='0'){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tcontent+=\"\t<td>草稿</td>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t}else if(n.status=='1'){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tcontent+=\"\t<td>未审核</td>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t}else if(n.status=='2'){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tcontent+=\"\t<td>审核完成</td>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t}else if(n.status=='3'){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tcontent+=\"\t<td>发布</td>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\tcontent+=\"\t<td>\";\r\n");
      out.write("\t\t\t\t\t\t\t\tcontent+=\"\t\t<button type='button' onclick='window.location.href=\\\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${APP_PATH}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/advert/edit.htm?pageno=\"+pageObj.pageno+\"&id=\"+n.id+\"\\\"' class='btn btn-primary btn-xs'>\";\r\n");
      out.write("\t\t\t\t\t\t\t\tcontent+=\"\t\t\t<i class=' glyphicon glyphicon-pencil'></i>\";\r\n");
      out.write("\t\t\t\t\t\t\t\tcontent+=\"\t\t</button>\";\r\n");
      out.write("\t\t\t\t\t\t\t\tcontent+=\"\t\t<button type='button' class='btn btn-danger btn-xs' onclick='deleteAdvert(\"+n.id+\",\\\"\"+n.name+\"\\\")'>\";\r\n");
      ...
      out.write("            \t\t\t}else{\r\n");
      out.write("            \t\t\t\t\r\n");
      out.write("            \t\t\t\tlayer.msg(\"广告分页查询数据失败\", {time:1000, icon:5, shift:6});\r\n");
      out.write("            \t\t\t\t\r\n");
      out.write("            \t\t\t}\r\n");
      out.write("            \t\t},\r\n");
      out.write("            \t\terror : function(){\r\n");
      out.write("            \t\t\tlayer.msg(\"广告分页查询数据错误\", {time:1000, icon:5, shift:6});\r\n");
      out.write("            \t\t}\r\n");
      out.write("            \t\t\r\n");
      out.write("            \t});\r\n");
      out.write("            }\r\n");
      ...
      out.write("            //条件查询\r\n");
      out.write("            function queryAdvert(){\r\n");
      out.write("            \tvar queryText = $(\"#queryText\");\r\n");
      out.write("            \t\r\n");
      out.write("            \tif($.trim(queryText.val())==\"\"){\r\n");
      ...
      out.write("            \tqueryPage(0);\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            function deleteAdvert(id,name){\r\n");
      out.write("            \t\r\n");
      out.write("    \t\t\tlayer.confirm(\"是否要删除广告?\",  {icon: 3, title:'提示'}, function(cindex){\r\n");
      out.write("    \t\t\t\t\r\n");
      out.write("    \t\t\t\t$.ajax({\r\n");
      out.write("    \t\t\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${APP_PATH}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/advert/delete.do\",\r\n");
      out.write("    \t\t\t\t\ttype : \"POST\",\r\n");
      out.write("    \t\t\t\t\tdata : {id:id},\r\n");
      out.write("    \t\t\t\t\tsuccess : function(result){\r\n");
      out.write("    \t\t\t\t\t\tif(result.success){\r\n");
      out.write("    \t\t\t\t\t\t\tlayer.msg(\"删除\"+name+\"广告成功!\", {time:1000, icon:6}, function(){\r\n");
      out.write("    \t\t\t\t\t\t\t\tqueryPage(0);\r\n");
      out.write("    \t\t\t\t\t\t\t});\r\n");
      out.write("    \t\t\t\t\t\t}else{\r\n");
      out.write("    \t\t\t\t\t\t\tlayer.msg(\"删除\"+name+\"广告失败!\", {time:1000, icon:5, shift:6});\r\n");
      out.write("    \t\t\t\t\t\t}\r\n");
      out.write("    \t\t\t\t\t}\r\n");
      out.write("    \t\t\t\t});\r\n");
      out.write("    \t\t\t\t\r\n");
      ...
      out.write("            \t\t\t\tdatas[\"datas[\"+i+\"].name\"]=\"n.name\";\r\n");
      out.write("            \t\t\t});\r\n");
      out.write("            \t\t\t\r\n");
      out.write("            \t\t\t$.ajax({\r\n");
      out.write("            \t\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${APP_PATH}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/advert/batchDelete.do\",\r\n");
      out.write("            \t\t\t\ttype : \"POST\",\r\n");
      out.write("            \t\t\t\tdata : datas ,\r\n");
      out.write("            \t\t\t\tsuccess : function(result){\r\n");
      out.write("            \t\t\t\t\tif(result.success){\r\n");
      out.write("\t            \t\t\t\t\tlayer.msg(\"删除广告成功!\", {time:1000, icon:6}, function(){\r\n");
      out.write("\t    \t\t\t\t\t\t\t\tqueryPage(0);\r\n");
      out.write("\t    \t\t\t\t\t\t\t});\r\n");
      out.write("            \t\t\t\t\t}else{\r\n");
      out.write("            \t\t\t\t\t\tlayer.msg(\"删除广告失败!\", {time:1000, icon:5});\r\n");
      out.write("            \t\t\t\t\t}\r\n");
      out.write("            \t\t\t\t}\r\n");
      out.write("            \t\t\t});\r\n");
      out.write("        \t\t\t    layer.close(cindex);\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/advert/index.jsp(144,7) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${empty param.pageno}", java.lang.Boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fif_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/advert/index.jsp(147,7) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f3.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${not empty param.pageno}", java.lang.Boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false)).booleanValue());
