 ...
 * Generated at: 2019-11-29 08:56:08 UTC
...
static {
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("          <div><a class=\"navbar-brand\" style=\"font-size:32px;\" href=\"#\">众筹平台 - 流程管理</a></div>\r\n");
      out.write("        </div>\r\n");
      ...
      out.write("          \t\t<input id=\"processDefFile\" type=\"file\" style=\"display:none\" name=\"processDefFile\">\r\n");
      out.write("          \t</form>\r\n");
      ...
      out.write("            });\r\n");
      out.write("            \r\n");
      out.write("            $(\"#uploadPrcDefBtn\").click(function(){\r\n");
      out.write("                  \t$(\"#deployForm\")[0].reset();//二次提交前重置表单\r\n");
      out.write("            \t$(\"#processDefFile\").click();\r\n");
      out.write("            });\r\n");
      out.write("            \r\n");
      out.write("    \r\n");
      ...
      out.write("               \t\t\t\tlayer.msg(result.message, {time:1000, icon:6});\r\n");
      out.write("               \t\t\t\tqueryPageUser(0);//异步刷新后，表单需要重置，否则二次上传失败，个人猜测是change状态没有改变\r\n");
      out.write("               \t\t\t\t/* window.location.href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${APP_PATH}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/process/index.htm\"; */\r\n");
      out.write("               \t\t\t}else{\r\n");
      ...
      out.write("             \r\n");
      out.write("            \r\n");
      out.write("            function deleteProcess(id,name){\r\n");
      out.write("            \tlayer.confirm(\"确认要删除[\"+name+\"]流程吗?\",  {icon: 3, title:'提示'}, function(cindex){\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${APP_PATH}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/process/showimg.htm?id='+n.id+'\\'\" class=\"btn btn-success btn-xs\"><i class=\" glyphicon glyphicon-eye-open\"></i></button>';\r\n");
      out.write("            \t\t\t\t\tcontent+='\t  <button type=\"button\" onclick=\"deleteProcess(\\''+n.id+'\\',\\''+n.name+'\\')\" class=\"btn btn-danger btn-xs\"><i class=\" glyphicon glyphicon-remove\"></i></button>';\r\n");
      out.write("            \t\t\t\t\tcontent+='  </td>';\r\n");
      out.write("            \t\t\t\t\tcontent+='</tr>';\r\n");
      out.write("            \t\t\t\t});\r\n");
      out.write("            \t\t\t\t\r\n");
      ...
      out.write("            \t\t\t\t\tcallback: queryPageUser,\t\t//回调函数，回调自己\r\n");
      out.write("            \t\t\t\t\titems_per_page: 10, //每页显示页数       //与自己设置的pagesize一致\r\n");
      out.write("            \t\t\t\t\tcurrent_page:(page.pageno-1),          //当前页，0代表第1页\r\n");
