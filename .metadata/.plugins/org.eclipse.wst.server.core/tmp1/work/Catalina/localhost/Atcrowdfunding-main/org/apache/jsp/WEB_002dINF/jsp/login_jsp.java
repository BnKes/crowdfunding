 ...
 * Generated at: 2019-12-01 14:09:01 UTC
...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<input type=\"text\" class=\"form-control\" id=\"floginacct\" name=\"loginacct\" value=\"zhangsan\" placeholder=\"请输入登录账号\" autofocus>\r\n");
      ...
      out.write("          <label>\r\n");
      out.write("            <input id=\"rememberme\" type=\"checkbox\" value=\"1\"> 记住我两周\r\n");
      out.write("          </label>\r\n");
      out.write("          <br>\r\n");
      out.write("          <label>\r\n");
      out.write("            忘记密码\r\n");
      ...
      out.write("/**\r\n");
      out.write(" * time:1000,  显示1000ms\r\n");
      out.write(" icon:5,    显示第5个图案，一个哭脸\r\n");
      out.write(" shift:6    弹窗抖动\r\n");
      out.write(" */\r\n");
      out.write("    \t\tlayer.msg(\"用户账号不能为空，请重新输入！\",{time:1000, icon:5, shift:6}, function(){   \r\n");
      out.write("    \t\t\tfloginacct.val(\"\");//赋值为空\r\n");
      out.write("        \t\tfloginacct.focus();\r\n");
      out.write("    \t\t});\r\n");
      out.write("    \t\treturn false;  //结束if\r\n");
      out.write("    \t}\r\n");
      out.write("    \t\r\n");
      out.write("    \tif($.trim(fuserpswd.val())==\"\"){\r\n");
      out.write("    \t//\talert(\"用户密码不能为空，请重新输入！\");\r\n");
      out.write("    \t\tlayer.msg(\"用户密码不能为空，请重新输入！\",{time:1000, icon:5, shift:6}, function(){\r\n");
      ...
      out.write("    \tvar flag = $(\"#rememberme\")[0].checked;  //选择为true,否则为false\r\n");
      out.write(" /*    \tvar ff = $(\"#rememberme\").val(); */\r\n");
      out.write("    \t$.ajax({\r\n");
      out.write("    \t\ttype : \"POST\",\r\n");
      out.write("    \t\tdata : {\r\n");
      ...
      out.write("    \t\t\tloadingIndex = layer.msg('处理中', {icon: 16});//转圈的图案\r\n");
      out.write("    \t\t\t//一般做表单数据校验.\r\n");
      out.write("    \t\t\treturn true ;\r\n");
      out.write("    \t\t},\r\n");
      out.write("    \t\tsuccess : function(result){ //{\"success\":true}  或    {\"success\":false,\"message\":\"登录失败!\"}\r\n");
      out.write("    \t\t\tlayer.close(loadingIndex);//关闭loadingIndex = layer.msg('处理中', {icon: 16})的layer\r\n");
      out.write("    \t\t\tif(result.success){    \r\n");
      out.write("     \t\t\t\tif(ftype.val()==\"user\"){\r\n");
      out.write("        \t\t\t\twindow.location.href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${APP_PATH}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/main.htm\";\r\n");
      out.write("    \t\t\t\t}else if(ftype.val()==\"member\"){ \r\n");
      out.write("    \t\t\t\t\twindow.location.href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${APP_PATH}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/member.htm\";\r\n");
      out.write("    \t\t\t\t}else{\r\n");
      out.write("    \t\t\t\t\tlayer.msg(\"登录身份有误!\", {time:1000, icon:5, shift:6});\r\n");
      out.write("    \t\t\t\t} \r\n");
      out.write("    \t\t\t}else{\r\n");
      ...
      out.write("    \t\t\tlayer.msg(\"登录出错啦!\", {time:1000, icon:5, shift:6});\r\n");
      out.write("    \t\t}\t\r\n");
      out.write("    \t});\r\n");
